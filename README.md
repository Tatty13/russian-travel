...
Разметка страницы осуществлена с использованием семантических тегов. Для выравнивания элементов применяются флексбоксы и гриды, реализована адаптивная вёрстка. Используются псевдоклассы.
